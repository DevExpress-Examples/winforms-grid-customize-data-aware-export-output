...
'INSTANT VB NOTE: The variable action was renamed since Visual Basic does not handle local variables named the same as class members well:
	...
	End Class
End Namespace
Namespace GridDataAwareExportCustomization.nwindDataSetTableAdapters
	...
	Partial Public Class CategoryProductsTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(1).CommandText = "SELECT ProductID, SupplierID, ProductName, CategoryName, Picture, Description FRO" & "M CategoryProducts"
		...
		Public Overridable Function FillBy(ByVal dataTable As nwindDataSet.CategoryProductsDataTable) As Integer
